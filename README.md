...
- Annotated dataset (*WikiLifeTrajectory*) for taining and testing in ```/data```
- A Sample from raw labeling process : ```/sample_data/sample.json```
- Life Trajectories Extracted from Wikipedia biography pages: ```/trajectory_data```
